 ...
 * @returns The detected MIME type string if valid, or null if invalid.
 */
export async function validateImageFile(file: File, maxSizeMb: number = 2): Promise<string | null> {
  // Check size limit
